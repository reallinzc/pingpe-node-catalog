/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f8cb9cdcea51889042f1211aa37cc754)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	STATE: KVNamespace;
	BROWSER: BrowserRun;
	PINGPE_TARGET: "191.223.216.145";
	GITHUB_OWNER: "reallinzc";
	GITHUB_REPO: "pingpe-node-catalog";
	GITHUB_BRANCH: "main";
	GITHUB_DATA_PATH: "data/pingpe-nodes.json";
	MIN_NODE_COUNT: "120";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PINGPE_TARGET" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_BRANCH" | "GITHUB_DATA_PATH" | "MIN_NODE_COUNT">> {}
}
